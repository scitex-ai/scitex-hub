...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@writer_app': path.resolve(__dirname, 'apps/workspace/writer_app/static/writer_app/ts'),
      '@public_app': path.resolve(__dirname, 'apps/infra/public_app/static/public_app/ts'),
