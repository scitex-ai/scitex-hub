...
scitex_agentic_journal_hub_app/
  ...
  templates/scitex_agentic_journal_hub_app/    # HTML templates
    index.html         # Full page (extends global_base)
    index_partial.html # AJAX-loadable partial
  static/scitex_agentic_journal_hub_app/css/   # Scoped stylesheets
...
1. Edit `templates/scitex_agentic_journal_hub_app/index_partial.html` to build your UI
2. Add view logic in `views.py`
3. Add styles in `static/scitex_agentic_journal_hub_app/css/scitex_agentic_journal_hub_app.css`
4. Run tests: `pytest apps/scitex_agentic_journal_hub_app/tests.py`
...
Agentic Journal is licensed under AGPL-3.0 — see `LICENSE` for details.
