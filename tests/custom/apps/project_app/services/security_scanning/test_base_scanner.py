#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/services/security_scanning/base_scanner.py"""

import pytest

# from apps.infra.project_app.services.security_scanning.base_scanner import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/services/security_scanning/base_scanner.py
# --------------------------------------------------------------------------------
# """
...
#         """
#         from apps.infra.project_app.models.security import SecurityScanResult
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/services/security_scanning/base_scanner.py
# --------------------------------------------------------------------------------
