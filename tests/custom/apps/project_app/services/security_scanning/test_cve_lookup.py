#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/services/security_scanning/cve_lookup.py"""

import pytest

# from apps.infra.project_app.services.security_scanning.cve_lookup import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/services/security_scanning/cve_lookup.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/services/security_scanning/cve_lookup.py
# --------------------------------------------------------------------------------
