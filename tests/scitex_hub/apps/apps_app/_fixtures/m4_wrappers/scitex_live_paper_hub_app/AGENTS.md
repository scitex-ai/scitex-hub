...
```
templates/scitex_live_paper_hub_app/index_partial.html   <- YOUR UI (main file to edit)
static/scitex_live_paper_hub_app/css/scitex_live_paper_hub_app.css          <- YOUR STYLES
...
2. Include your CSS: `<link rel="stylesheet" href="{% static 'scitex_live_paper_hub_app/css/scitex_live_paper_hub_app.css' %}">`
3. Wrap everything in a scoped container: `<div class="scitex_live_paper_hub_app-container">`
...
```html
{% load static %}
<link rel="stylesheet" href="{% static 'scitex_live_paper_hub_app/css/scitex_live_paper_hub_app.css' %}">

<div class="scitex_live_paper_hub_app-container" data-pane-type="app">
    <div class="scitex_live_paper_hub_app-header" data-ai-hint="App header with title">
        <h2><i class="fas fa-file-alt"></i> Live Paper</h2>
    </div>
    <div class="scitex_live_paper_hub_app-content" data-ai-hint="Main interactive area">
...
- Scope ALL rules under `.scitex_live_paper_hub_app-container` to avoid conflicts
...
`build_scitex_live_paper_hub_app_context(request, current_project)` returns template context.
