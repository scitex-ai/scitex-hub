#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/views/notebook_views.py"""
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/views/notebook_views.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/views/notebook_views.py
# --------------------------------------------------------------------------------
