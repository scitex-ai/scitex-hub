#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/api/templates_api.py"""

import pytest

# from apps.workspace.console_app.api.templates_api import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/api/templates_api.py
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/api/templates_api.py
# --------------------------------------------------------------------------------
