#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/donations_app/views.py"""

import pytest

# from apps.donations_app.views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/donations_app/views.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/donations_app/views.py
# --------------------------------------------------------------------------------
