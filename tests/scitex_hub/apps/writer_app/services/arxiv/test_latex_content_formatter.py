#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/writer_app/services/arxiv/latex_content_formatter.py"""

import pytest

# from apps.workspace.writer_app.services.arxiv.latex_content_formatter import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/writer_app/services/arxiv/latex_content_formatter.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/writer_app/services/arxiv/latex_content_formatter.py
# --------------------------------------------------------------------------------
