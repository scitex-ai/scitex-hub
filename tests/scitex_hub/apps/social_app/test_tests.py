#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/social_app/tests.py"""

import pytest

# from apps.infra.social_app.tests import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/social_app/tests.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
#             username="user1", email="user1@example.com", password="testpass123"  # pragma: allowlist secret
#         )
#         self.user2 = User.objects.create_user(
#             username="user2", email="user2@example.com", password="testpass123"  # pragma: allowlist secret
#         )
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/social_app/tests.py
# --------------------------------------------------------------------------------
