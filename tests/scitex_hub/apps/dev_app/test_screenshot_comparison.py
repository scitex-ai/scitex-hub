#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/dev_app/screenshot_comparison.py"""

import pytest

# from apps.workspace.dev_app.screenshot_comparison import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/dev_app/screenshot_comparison.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
# LOCAL_PASSWORD = "test"  # pragma: allowlist secret
#
# # Output directory
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/dev_app/screenshot_comparison.py
# --------------------------------------------------------------------------------
