#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/public_app/tests.py"""

import pytest

# from apps.infra.public_app.tests import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/public_app/tests.py
# --------------------------------------------------------------------------------
...
#             name="Free", plan_type="free", price_monthly=0, max_projects=1, storage_gb=5
#         )
#
...
#         verification = EmailVerification.objects.create(email="test@example.com")
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/public_app/tests.py
# --------------------------------------------------------------------------------
