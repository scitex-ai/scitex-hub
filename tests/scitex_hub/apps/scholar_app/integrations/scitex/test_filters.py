#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/integrations/scitex/filters.py"""

import pytest

# from apps.workspace.scholar_app.integrations.scitex.filters import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/integrations/scitex/filters.py
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/integrations/scitex/filters.py
# --------------------------------------------------------------------------------
