#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/views/search/search_helpers.py"""
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/views/search/search_helpers.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # File: /home/ywatanabe/proj/scitex-hub/apps/scholar_app/views/search/search_helpers.py
