#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/api/viewsets.py"""

import pytest

# from apps.workspace.scholar_app.api.viewsets import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/api/viewsets.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
#         return Paper.objects.filter(userlibrary__user=user).distinct()
#
...
#         user = self.request.user
#         return Annotation.objects.filter(user=user).distinct()
#
#     def perform_create(self, serializer):
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/api/viewsets.py
# --------------------------------------------------------------------------------
