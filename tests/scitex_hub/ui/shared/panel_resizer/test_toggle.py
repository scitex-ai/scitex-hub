...
class TestPanelToggle:
    ...
    def test_toggle_button_collapses_panel(
        ...
        show_step(
            ...
            2,
            4,
            f"Initial: collapsed={initial_collapsed}, width={initial_width}px",
            "info",
        )
        ...
        assert (
            new_collapsed != initial_collapsed
        ), "Toggle did not change collapse state"
        ...
        if new_collapsed:
            show_step(
                ...
                4,
                4,
                f"Panel collapsed: {initial_width}px → {new_width}px ✓",
                "success",
            )
        else:
            show_step(
                ...
                4,
                4,
                f"Panel expanded: {initial_width}px → {new_width}px ✓",
                "success",
            )
    ...
    def test_toggle_icon_updates(
        ...
        show_step(
            page, 3, 3, f"Icon changed: {initial_classes} → {new_classes} ✓", "success"
        )
