...
from scitex_hub._cli._gitea_auth import login as gitea_login
from scitex_hub._cli._gitea_auth import logout as gitea_logout
from scitex_hub._cli._gitea_repo import delete as repo_delete
from scitex_hub._cli.project import project_delete
from scitex_hub._cli.setup import setup as setup_cmd
...
class TestGiteaLoginNoPrompt:
    ...
    def test_token_from_envvar_skips_username_flow(
        ...
        with (
            ...
            patch("scitex_hub._cli._gitea_auth.run_tea") as run_tea,
        ):
            result = runner.invoke(gitea_login, [], input="")
...
class TestProjectDeleteNoPrompt:
    ...
    def test_delete_with_yes_calls_backend(self, runner, isolated_env, monkeypatch):
        with patch("scitex_hub.project.project_delete") as backend:
