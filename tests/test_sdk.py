#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for scitex_cloud.sdk — Platform SDK client library."""
...
class TestPlatformClient:
    ...
    def test_defaults(self):
        from scitex_cloud.sdk._client import PlatformClient
    ...
    def test_get_client_singleton(self):
        from scitex_cloud.sdk._client import get_client, reset_client
...
class TestDataModule:
    """Test scitex_cloud.sdk.data functions."""

    @patch("scitex_cloud.sdk._data.get_client")
...
class TestFilesModule:
    """Test scitex_cloud.sdk.files functions."""

    @patch("scitex_cloud.sdk._files.get_client")
...
class TestJobsModule:
    """Test scitex_cloud.sdk.jobs functions."""

    @patch("scitex_cloud.sdk._jobs.get_client")
