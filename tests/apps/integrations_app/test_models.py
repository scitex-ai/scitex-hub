#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/integrations_app/models.py"""

import pytest

# from apps.infra.integrations_app.models import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/integrations_app/models.py
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/integrations_app/models.py
# --------------------------------------------------------------------------------
