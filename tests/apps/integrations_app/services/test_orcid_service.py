#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/integrations_app/services/orcid_service.py"""

import pytest

# from apps.infra.integrations_app.services.orcid_service import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/integrations_app/services/orcid_service.py
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/integrations_app/services/orcid_service.py
# --------------------------------------------------------------------------------
