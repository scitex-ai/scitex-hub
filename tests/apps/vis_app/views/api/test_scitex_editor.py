#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/vis_app/views/api/scitex_editor.py"""

import pytest

# from apps.workspace.vis_app.views.api.scitex_editor import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/vis_app/views/api/scitex_editor.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/vis_app/views/api/scitex_editor.py
# --------------------------------------------------------------------------------
