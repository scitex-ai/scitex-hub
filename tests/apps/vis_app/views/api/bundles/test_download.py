#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/vis_app/views/api/bundles/download.py"""

import pytest

# from apps.workspace.vis_app.views.api.bundles.download import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/vis_app/views/api/bundles/download.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/vis_app/views/api/bundles/download.py
# --------------------------------------------------------------------------------
