#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/vis_app/views/api/bundles/create.py"""

import pytest

# from apps.workspace.vis_app.views.api.bundles.create import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/vis_app/views/api/bundles/create.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/vis_app/views/api/bundles/create.py
# --------------------------------------------------------------------------------
