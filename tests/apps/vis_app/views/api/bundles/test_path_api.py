#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/vis_app/views/api/bundles/path_api.py"""

import pytest

# from apps.workspace.vis_app.views.api.bundles.path_api import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/vis_app/views/api/bundles/path_api.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/vis_app/views/api/bundles/path_api.py
# --------------------------------------------------------------------------------
