#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/vis_app/views/api/figures.py"""

import pytest

# from apps.workspace.vis_app.views.api.figures import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/vis_app/views/api/figures.py
# --------------------------------------------------------------------------------
# """
...
#
# from apps.workspace.vis_app.models import ScientificFigure, FigurePanel
#
#
# @login_required
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/vis_app/views/api/figures.py
# --------------------------------------------------------------------------------
