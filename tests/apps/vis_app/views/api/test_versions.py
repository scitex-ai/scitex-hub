#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/vis_app/views/api/versions.py"""

import pytest

# from apps.workspace.vis_app.views.api.versions import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/vis_app/views/api/versions.py
# --------------------------------------------------------------------------------
# """
...
#
# from apps.workspace.vis_app.models import ScientificFigure, FigureVersion
#
#
# @login_required
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/vis_app/views/api/versions.py
# --------------------------------------------------------------------------------
