#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/vis_app/views/api/presets.py"""

import pytest

# from apps.workspace.vis_app.views.api.presets import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/vis_app/views/api/presets.py
# --------------------------------------------------------------------------------
# """
...
#
# from apps.workspace.vis_app.models import JournalPreset
#
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/vis_app/views/api/presets.py
# --------------------------------------------------------------------------------
