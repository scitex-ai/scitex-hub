#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/vis_app/services/plot_renderer/plot_types_statistical.py"""

import pytest

# from apps.workspace.vis_app.services.plot_renderer.plot_types_statistical import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/vis_app/services/plot_renderer/plot_types_statistical.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/vis_app/services/plot_renderer/plot_types_statistical.py
# --------------------------------------------------------------------------------
