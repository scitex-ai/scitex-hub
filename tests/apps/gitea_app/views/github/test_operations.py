#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/gitea_app/views/github/operations.py"""

import pytest

# from apps.infra.gitea_app.views.github.operations import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/gitea_app/views/github/operations.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/gitea_app/views/github/operations.py
# --------------------------------------------------------------------------------
