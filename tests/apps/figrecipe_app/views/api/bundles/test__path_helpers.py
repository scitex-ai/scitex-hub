...
class TestResolveBundlePath:
    ...
    def test_absolute_path_returned_unchanged(self):
        ...
        from apps.workspace.figrecipe_app.views.api.bundles._path_helpers import (
            resolve_bundle_path,
        )
    ...
    def test_relative_path_with_project_context(self):
        ...
        with patch("apps.infra.project_app.models.Project") as MockProject:
            ...
            assert result == Path(
                "/data/projects/owner/slug/scitex/vis/figures/Figure1.figz"
            )
    ...
    def test_relative_path_with_user_fallback(self):
        ...
        with patch(
            "apps.infra.project_app.services.project_utils.get_user_project"
        ) as mock_get:
            mock_get.return_value = mock_project

            result = resolve_bundle_path(
                "scitex/vis/figures/Figure1.figz", user=mock_user
            )
