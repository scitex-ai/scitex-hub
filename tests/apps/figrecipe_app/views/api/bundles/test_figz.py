#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/figrecipe_app/views/api/bundles/figz.py"""

import pytest

# from apps.workspace.figrecipe_app.views.api.bundles.figz import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/figrecipe_app/views/api/bundles/figz.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/figrecipe_app/views/api/bundles/figz.py
# --------------------------------------------------------------------------------
