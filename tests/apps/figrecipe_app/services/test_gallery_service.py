#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/figrecipe_app/services/gallery_service.py"""

import pytest

# from apps.workspace.figrecipe_app.services.gallery_service import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/figrecipe_app/services/gallery_service.py
# --------------------------------------------------------------------------------
# """
...
#
#         if not json_path.exists():
#             # Try alternate paths in the figrecipe_app static gallery
#             alt_paths = [
#                 Path(settings.BASE_DIR) / 'apps' / 'figrecipe_app' / 'static' / 'figrecipe_app' / 'img' / 'plot_gallery' / '01_matplotlib_basic',
#                 Path(settings.BASE_DIR) / 'apps' / 'figrecipe_app' / 'static' / 'figrecipe_app' / 'img' / 'plot_gallery' / '02_custom_scitex',
#                 Path(settings.BASE_DIR) / 'apps' / 'figrecipe_app' / 'static' / 'figrecipe_app' / 'img' / 'plot_gallery' / '04_seaborn',
#             ]
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/figrecipe_app/services/gallery_service.py
# --------------------------------------------------------------------------------
