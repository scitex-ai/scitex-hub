#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/figrecipe_app/services/plot_renderer/plot_types_basic.py"""

import pytest

# from apps.workspace.figrecipe_app.services.plot_renderer.plot_types_basic import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/figrecipe_app/services/plot_renderer/plot_types_basic.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/figrecipe_app/services/plot_renderer/plot_types_basic.py
# --------------------------------------------------------------------------------
