#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/figrecipe_app/services/plot_renderer/single_plot.py"""

import pytest

# from apps.workspace.figrecipe_app.services.plot_renderer.single_plot import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/figrecipe_app/services/plot_renderer/single_plot.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/figrecipe_app/services/plot_renderer/single_plot.py
# --------------------------------------------------------------------------------
