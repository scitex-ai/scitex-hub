...
# File: /home/ywatanabe/proj/scitex-cloud/tests/apps/figrecipe_app/services/test_figz_service.py
...
class TestSaveCanvasAsBundle:
    ...
    def test_save_preserves_embedded_panels(
        ...
        from apps.workspace.figrecipe_app.services.figz import save_canvas_as_bundle
        ...
        with mock.patch(
            "apps.workspace.figrecipe_app.services.figz.get_bundle_base_path"
        ) as mock_path:
