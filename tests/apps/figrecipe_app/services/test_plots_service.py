#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/figrecipe_app/services/plots_service.py"""

import pytest

# from apps.workspace.figrecipe_app.services.plots_service import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/figrecipe_app/services/plots_service.py
# --------------------------------------------------------------------------------
# """
...
#         from apps.workspace.figrecipe_app.services.plot_renderer.element_bboxes import extract_element_bboxes
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/figrecipe_app/services/plots_service.py
# --------------------------------------------------------------------------------
