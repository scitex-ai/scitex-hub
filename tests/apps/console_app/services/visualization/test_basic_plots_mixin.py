#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/services/visualization/basic_plots_mixin.py"""

import pytest

# from apps.workspace.console_app.services.visualization.basic_plots_mixin import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/services/visualization/basic_plots_mixin.py
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/services/visualization/basic_plots_mixin.py
# --------------------------------------------------------------------------------
