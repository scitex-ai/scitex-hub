#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/services/jupyter/validator.py"""

import pytest

# from apps.workspace.console_app.services.jupyter.validator import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/services/jupyter/validator.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
# Notebook validation and sanitization utilities.
# """
#
# import json
# import logging
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/services/jupyter/validator.py
# --------------------------------------------------------------------------------
