#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/services/jupyter/executor.py"""

import pytest

# from apps.workspace.console_app.services.jupyter.executor import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/services/jupyter/executor.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/services/jupyter/executor.py
# --------------------------------------------------------------------------------
