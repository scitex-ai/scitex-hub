#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/services/singularity_manager/resource_manager.py"""

import pytest

# from apps.workspace.console_app.services.singularity_manager.resource_manager import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/services/singularity_manager/resource_manager.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Timestamp: "2025-11-29 14:46:00 (ywatanabe)"
# # File: .../apps/console_app/services/singularity_manager/resource_manager.py
# # ----------------------------------------
# from __future__ import annotations
#
# __FILE__ = "./apps/console_app/services/singularity_manager/resource_manager.py"
# # ----------------------------------------
#
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/services/singularity_manager/resource_manager.py
# --------------------------------------------------------------------------------
