#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/integrations/repository_integration.py"""

import pytest

# from apps.workspace.console_app.integrations.repository_integration import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/integrations/repository_integration.py
# --------------------------------------------------------------------------------
# """
...
# from apps.workspace.scholar_app.models import (
#     Dataset,
#     DatasetFile,
#     RepositoryConnection,
# )
# from apps.workspace.scholar_app.repository_services import (
...
#         return dataset
#
#     def _create_dataset_from_analysis_job(
#         self, analysis_job: DataAnalysisJob
#     ) -> Dataset:
...
#
#     def _add_analysis_outputs_to_dataset(
#         self, analysis_job: DataAnalysisJob, dataset: Dataset
#     ):
...
#         self._update_dataset_stats(dataset)
#
#     def _add_output_file_to_dataset(
#         self, dataset: Dataset, file_path: str, file_type: str
#     ):
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/integrations/repository_integration.py
# --------------------------------------------------------------------------------
