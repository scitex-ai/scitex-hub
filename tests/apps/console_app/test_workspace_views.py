#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/workspace_views.py"""

import pytest

# from apps.workspace.console_app.workspace_views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/workspace_views.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/workspace_views.py
# --------------------------------------------------------------------------------
