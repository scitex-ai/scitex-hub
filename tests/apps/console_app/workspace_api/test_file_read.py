#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/workspace_api/file_read.py"""

import pytest

# from apps.workspace.console_app.workspace_api.file_read import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/workspace_api/file_read.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/workspace_api/file_read.py
# --------------------------------------------------------------------------------
