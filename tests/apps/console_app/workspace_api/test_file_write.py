#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/workspace_api/file_write.py"""

import pytest

# from apps.console_app.workspace_api.file_write import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/workspace_api/file_write.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/workspace_api/file_write.py
# --------------------------------------------------------------------------------
