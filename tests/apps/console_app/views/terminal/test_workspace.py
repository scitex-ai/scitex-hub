...
# from apps.console_app.views.terminal.workspace import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/views/terminal/workspace.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/views/terminal/workspace.py
# --------------------------------------------------------------------------------
