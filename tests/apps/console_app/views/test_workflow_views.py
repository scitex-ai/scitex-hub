#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/views/workflow_views.py"""

import pytest

# from apps.workspace.console_app.views.workflow_views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/views/workflow_views.py
# --------------------------------------------------------------------------------
# """
...
#     return render(request, "console_app/workflows.html", context)
#
#
# @login_required
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/views/workflow_views.py
# --------------------------------------------------------------------------------
