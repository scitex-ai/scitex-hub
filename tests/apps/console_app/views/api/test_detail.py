#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/console_app/views/api/detail.py"""

import pytest

# from apps.workspace.console_app.views.api.detail import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/console_app/views/api/detail.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
#
#             return JsonResponse(
#                 {"status": "success", "message": "Notebook updated successfully"}
#             )
#
...
#
#             return JsonResponse(
#                 {"status": "success", "message": "Notebook deleted successfully"}
#             )
#
#         except Exception as e:
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/console_app/views/api/detail.py
# --------------------------------------------------------------------------------
