#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/services/visualization/basic_plots_mixin.py"""

import pytest

# from apps.code_app.services.visualization.basic_plots_mixin import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/services/visualization/basic_plots_mixin.py
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/services/visualization/basic_plots_mixin.py
# --------------------------------------------------------------------------------
