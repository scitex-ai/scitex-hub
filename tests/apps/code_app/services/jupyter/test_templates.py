#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/services/jupyter/templates.py"""

import pytest

# from apps.code_app.services.jupyter.templates import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/services/jupyter/templates.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/services/jupyter/templates.py
# --------------------------------------------------------------------------------
