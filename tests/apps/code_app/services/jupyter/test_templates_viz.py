#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/services/jupyter/templates_viz.py"""

import pytest

# from apps.code_app.services.jupyter.templates_viz import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/services/jupyter/templates_viz.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/services/jupyter/templates_viz.py
# --------------------------------------------------------------------------------
