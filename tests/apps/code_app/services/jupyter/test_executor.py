#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/services/jupyter/executor.py"""

import pytest

# from apps.code_app.services.jupyter.executor import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/services/jupyter/executor.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/services/jupyter/executor.py
# --------------------------------------------------------------------------------
