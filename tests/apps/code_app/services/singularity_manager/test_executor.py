#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/services/singularity_manager/executor.py"""

import pytest

# from apps.code_app.services.singularity_manager.executor import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/services/singularity_manager/executor.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/services/singularity_manager/executor.py
# --------------------------------------------------------------------------------
