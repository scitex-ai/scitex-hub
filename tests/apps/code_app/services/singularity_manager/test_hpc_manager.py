#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/services/singularity_manager/hpc_manager.py"""

import pytest

# from apps.code_app.services.singularity_manager.hpc_manager import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/services/singularity_manager/hpc_manager.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/services/singularity_manager/hpc_manager.py
# --------------------------------------------------------------------------------
