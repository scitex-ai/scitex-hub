#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/workspace_api/file_read.py"""

import pytest

# from apps.code_app.workspace_api.file_read import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/workspace_api/file_read.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/workspace_api/file_read.py
# --------------------------------------------------------------------------------
