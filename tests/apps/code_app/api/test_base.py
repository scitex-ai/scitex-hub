#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/api/base.py"""

import pytest

# from apps.code_app.api.base import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/api/base.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/api/base.py
# --------------------------------------------------------------------------------
