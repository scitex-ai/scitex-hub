#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/job_api_views.py"""

import pytest

# from apps.code_app.job_api_views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/job_api_views.py
# --------------------------------------------------------------------------------
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/job_api_views.py
# --------------------------------------------------------------------------------
