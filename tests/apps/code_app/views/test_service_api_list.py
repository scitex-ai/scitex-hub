#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/views/service_api_list.py"""

import pytest

# from apps.code_app.views.service_api_list import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/views/service_api_list.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/views/service_api_list.py
# --------------------------------------------------------------------------------
