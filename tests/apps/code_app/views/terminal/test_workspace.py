#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/views/terminal/workspace.py"""

import pytest

# from apps.code_app.views.terminal.workspace import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/views/terminal/workspace.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/views/terminal/workspace.py
# --------------------------------------------------------------------------------
