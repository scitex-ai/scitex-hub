#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/views/terminal/dotfiles.py"""

import pytest

# from apps.code_app.views.terminal.dotfiles import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/views/terminal/dotfiles.py
# --------------------------------------------------------------------------------
# """
# Dotfiles Management
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/views/terminal/dotfiles.py
# --------------------------------------------------------------------------------
