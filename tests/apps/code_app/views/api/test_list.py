#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/views/api/list.py"""

import pytest

# from apps.code_app.views.api.list import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/views/api/list.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/views/api/list.py
# --------------------------------------------------------------------------------
