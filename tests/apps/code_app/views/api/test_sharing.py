#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/views/api/sharing.py"""

import pytest

# from apps.code_app.views.api.sharing import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/views/api/sharing.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/views/api/sharing.py
# --------------------------------------------------------------------------------
