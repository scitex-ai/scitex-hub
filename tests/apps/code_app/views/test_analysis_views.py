#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/views/analysis_views.py"""

import pytest

# from apps.code_app.views.analysis_views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/views/analysis_views.py
# --------------------------------------------------------------------------------
# """
# Data analysis views.
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/views/analysis_views.py
# --------------------------------------------------------------------------------
