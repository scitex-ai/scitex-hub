#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/code_app/views/workflow_views.py"""

import pytest

# from apps.code_app.views.workflow_views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/code_app/views/workflow_views.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/code_app/views/workflow_views.py
# --------------------------------------------------------------------------------
