...
apps. The grid launcher now applies the mounts' own predicates. (The header
app launcher that also did was removed on 2026-09-14 with the Home + dock
redesign, and its two tests with it.)
