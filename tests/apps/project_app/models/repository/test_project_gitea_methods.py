#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/models/repository/project_gitea_methods.py"""

import pytest

# from apps.infra.project_app.models.repository.project_gitea_methods import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/models/repository/project_gitea_methods.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/models/repository/project_gitea_methods.py
# --------------------------------------------------------------------------------
