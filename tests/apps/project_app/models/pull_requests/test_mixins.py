#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/models/pull_requests/mixins.py"""

import pytest

# from apps.infra.project_app.models.pull_requests.mixins import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/models/pull_requests/mixins.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/models/pull_requests/mixins.py
# --------------------------------------------------------------------------------
