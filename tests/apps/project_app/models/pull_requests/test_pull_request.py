#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/models/pull_requests/pull_request.py"""

import pytest

# from apps.infra.project_app.models.pull_requests.pull_request import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/models/pull_requests/pull_request.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/models/pull_requests/pull_request.py
# --------------------------------------------------------------------------------
