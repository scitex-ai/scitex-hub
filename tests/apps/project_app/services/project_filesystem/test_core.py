#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/services/project_filesystem/core.py"""

import pytest

# from apps.infra.project_app.services.project_filesystem.core import ...
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/services/project_filesystem/core.py
# --------------------------------------------------------------------------------
