#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/services/syntax_highlighting.py"""

import pytest

# from apps.infra.project_app.services.syntax_highlighting import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/services/syntax_highlighting.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/services/syntax_highlighting.py
# --------------------------------------------------------------------------------
