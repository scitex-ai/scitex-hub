#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/signals/gitea_repository.py"""

import pytest

# from apps.infra.project_app.signals.gitea_repository import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/signals/gitea_repository.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/signals/gitea_repository.py
# --------------------------------------------------------------------------------
