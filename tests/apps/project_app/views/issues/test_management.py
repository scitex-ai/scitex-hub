#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/views/issues/management.py"""

import pytest

# from apps.infra.project_app.views.issues.management import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/views/issues/management.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/views/issues/management.py
# --------------------------------------------------------------------------------
