#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/views/workflows/runs.py"""

import pytest

# from apps.infra.project_app.views.workflows.runs import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/views/workflows/runs.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
# # from apps.infra.project_app.models import WorkflowRun, Workflow, WorkflowJob
#
...
#
#         # Create workflow run
#         from apps.infra.project_app.tasks.workflow_tasks import execute_workflow_run
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/views/workflows/runs.py
# --------------------------------------------------------------------------------
