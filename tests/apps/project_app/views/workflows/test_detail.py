#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/views/workflows/detail.py"""

import pytest

# from apps.infra.project_app.views.workflows.detail import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/views/workflows/detail.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
# # from apps.infra.project_app.models import Workflow, WorkflowRun
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/views/workflows/detail.py
# --------------------------------------------------------------------------------
