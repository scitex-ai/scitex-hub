#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/project_app/views/pr/detail_views.py"""

import pytest

# from apps.infra.project_app.views.pr.detail_views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/project_app/views/pr/detail_views.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/project_app/views/pr/detail_views.py
# --------------------------------------------------------------------------------
