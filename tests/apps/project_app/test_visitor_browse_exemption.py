...
``/apps/my-projects/?project=NNNNN``) therefore held the entire pool —
...
class RepoBrowsePathClassificationTest(TestCase):
    ...
    def test_numeric_project_query_is_enumeration(self):
        ...
        query = {"project": "31337"}
        # Act
        matched = is_hub_project_enumeration("/apps/my-projects/", query)
        # Assert
        assert matched is True
...
class BrowseExemptionTakesNoSlotTest(_AllocatablePoolTestCase):
    ...
    def test_hub_project_enumeration_allocates_nothing(self):
        # Arrange: the sequential /apps/my-projects/?project=NNNNN walk.
        path = "/apps/my-projects/"
        # Act
...
class AppPagesStillAllocateTest(_AllocatablePoolTestCase):
    ...
    def test_hero_cta_hub_index_still_allocates(self):
        # Arrange: bare /apps/my-projects/, no ?project=, is the hero CTA.
        path = "/apps/my-projects/"
        # Act
        self.run_middleware(path)
        # Assert
...
class ExemptPathStillRendersTest(_AllocatablePoolTestCase):
    ...
    def test_hub_enumeration_redirects_anonymous_to_signin(self):
        ...
        # browser hitting /apps/my-projects/ (with or without ?project=<id>) must be
