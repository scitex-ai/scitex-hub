#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/auth_app/api/auth_views.py"""

import pytest

# from apps.infra.auth_app.api.auth_views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/auth_app/api/auth_views.py
# --------------------------------------------------------------------------------
# """
# Auth API Views
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/auth_app/api/auth_views.py
# --------------------------------------------------------------------------------
