#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/middleware/rate_limit.py"""

import pytest

# from apps.scholar_app.middleware.rate_limit import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/middleware/rate_limit.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # File: /home/ywatanabe/proj/scitex-cloud/apps/scholar_app/middleware/rate_limit.py
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/middleware/rate_limit.py
# --------------------------------------------------------------------------------
