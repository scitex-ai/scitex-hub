#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/views/annotation/views.py"""
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/views/annotation/views.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# """
...
#         return JsonResponse(
#             {"success": False, "error": "Annotation not found"}, status=404
#         )
#     except Exception as e:
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/views/annotation/views.py
# --------------------------------------------------------------------------------
