#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/views/search/engines/core.py"""
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/views/search/engines/core.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
#                 logger.warning(
#                     f"   ℹ️ Add API keys at /scholar/api-keys/ for better performance"
#                 )
#     else:
