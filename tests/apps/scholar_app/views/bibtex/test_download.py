#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/views/bibtex/download.py"""

import pytest

# from apps.workspace.scholar_app.views.bibtex.download import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/views/bibtex/download.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # File: /home/ywatanabe/proj/scitex-hub/apps/scholar_app/views/bibtex/download.py
#
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/views/bibtex/download.py
# --------------------------------------------------------------------------------
