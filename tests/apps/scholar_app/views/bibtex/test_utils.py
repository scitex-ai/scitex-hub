#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/views/bibtex/utils.py"""

import pytest

# from apps.workspace.scholar_app.views.bibtex.utils import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/views/bibtex/utils.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # File: /home/ywatanabe/proj/scitex-hub/apps/scholar_app/views/bibtex/utils.py
#
# """
...
#         from apps.workspace.scholar_app.integrations.scitex_scholar import get_user_scitex_dir
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/views/bibtex/utils.py
# --------------------------------------------------------------------------------
