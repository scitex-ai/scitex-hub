#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/views/workspace/api_key_views.py"""

import pytest

# from apps.workspace.scholar_app.views.workspace.api_key_views import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/views/workspace/api_key_views.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
#                 messages.success(
#                     request,
#                     f"{source.replace('_', ' ').title()} API key updated successfully!",
#                 )
#             else:
#                 # Clear the API key
#                 user_prefs.set_api_key(source, "")
#                 messages.info(
#                     request, f"{source.replace('_', ' ').title()} API key cleared."
#                 )
#         else:
...
#             return JsonResponse(
#                 {"success": False, "error": "Missing source or API key"}
#             )
#
...
#
#     usage_data = {
#         "total_requests": sum(user_prefs.api_usage_count.values())
#         if user_prefs.api_usage_count
#         else 0,
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/views/workspace/api_key_views.py
# --------------------------------------------------------------------------------
