#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/models/bibtex/models.py"""

import pytest

# from apps.workspace.scholar_app.models.bibtex.models import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/models/bibtex/models.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # File: /home/ywatanabe/proj/scitex-hub/apps/scholar_app/bibtex_models.py
#
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/models/bibtex/models.py
# --------------------------------------------------------------------------------
