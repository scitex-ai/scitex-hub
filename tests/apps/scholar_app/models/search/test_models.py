#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/models/search/models.py"""
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/models/search/models.py
# --------------------------------------------------------------------------------
...
#         max_length=20, choices=SEARCH_TYPE_CHOICES, default="simple"
#     )
...
#     query_text = models.TextField()
#     search_type = models.CharField(
#         max_length=20, choices=SearchQuery.SEARCH_TYPE_CHOICES
#     )
#     filters = models.JSONField(default=dict, blank=True)
#     email_alerts = models.BooleanField(default=False)
#     alert_frequency = models.CharField(
#         max_length=10, choices=FREQUENCY_CHOICES, default="never"
#     )
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/models/search/models.py
# --------------------------------------------------------------------------------
