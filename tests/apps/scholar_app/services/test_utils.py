#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/services/utils.py"""
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/services/utils.py
# --------------------------------------------------------------------------------
# """
...
#                     name_parts.append(author.middle_name)
#                 author_lines.append(
#                     f"AU  - {name_parts[0]}, {' '.join(name_parts[1:])}"
#                 )
#             elif author.last_name:
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/services/utils.py
# --------------------------------------------------------------------------------
