#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/services/repository/doi_metadata_builder.py"""

import pytest

# from apps.workspace.scholar_app.services.repository.doi_metadata_builder import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/services/repository/doi_metadata_builder.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/services/repository/doi_metadata_builder.py
# --------------------------------------------------------------------------------
