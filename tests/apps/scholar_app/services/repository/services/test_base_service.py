#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/services/repository/services/base_service.py"""
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/services/repository/services/base_service.py
# --------------------------------------------------------------------------------
