#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/scholar_app/integrations/scitex/converters.py"""

import pytest

# from apps.workspace.scholar_app.integrations.scitex.converters import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/scholar_app/integrations/scitex/converters.py
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/scholar_app/integrations/scitex/converters.py
# --------------------------------------------------------------------------------
