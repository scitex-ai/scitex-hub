#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/writer_app/services/arxiv/compliance_checker.py"""

import pytest

# from apps.workspace.writer_app.services.arxiv.compliance_checker import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/writer_app/services/arxiv/compliance_checker.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/writer_app/services/arxiv/compliance_checker.py
# --------------------------------------------------------------------------------
