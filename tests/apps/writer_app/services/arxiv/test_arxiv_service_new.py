#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/writer_app/services/arxiv/arxiv_service_new.py"""

import pytest

# from apps.workspace.writer_app.services.arxiv.arxiv_service_new import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/writer_app/services/arxiv/arxiv_service_new.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/writer_app/services/arxiv/arxiv_service_new.py
# --------------------------------------------------------------------------------
