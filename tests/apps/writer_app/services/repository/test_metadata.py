#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/writer_app/services/repository/metadata.py"""

import pytest

# from apps.workspace.writer_app.services.repository.metadata import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/writer_app/services/repository/metadata.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/writer_app/services/repository/metadata.py
# --------------------------------------------------------------------------------
