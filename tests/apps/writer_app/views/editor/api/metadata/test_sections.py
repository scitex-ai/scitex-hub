#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/writer_app/views/editor/api/metadata/sections.py"""

import pytest

# from apps.workspace.writer_app.views.editor.api.metadata.sections import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/writer_app/views/editor/api/metadata/sections.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/writer_app/views/editor/api/metadata/sections.py
# --------------------------------------------------------------------------------
