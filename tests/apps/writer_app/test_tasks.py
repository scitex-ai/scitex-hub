#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/writer_app/tasks.py"""

import pytest

# from apps.workspace.writer_app.tasks import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/writer_app/tasks.py
# --------------------------------------------------------------------------------
# # -*- coding: utf-8 -*-
...
# @shared_task(
#     bind=True,
#     name="apps.workspace.writer_app.tasks.ai_suggest",
#     max_retries=3,
#     soft_time_limit=60,
#     time_limit=120,
...
# @shared_task(
#     bind=True,
#     name="apps.workspace.writer_app.tasks.ai_generate",
#     max_retries=2,
#     soft_time_limit=120,
#     time_limit=180,
...
# @shared_task(
#     bind=True,
#     name="apps.workspace.writer_app.tasks.compile_latex",
#     soft_time_limit=300,
#     time_limit=360,
#     rate_limit="20/m",
# )
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/writer_app/tasks.py
# --------------------------------------------------------------------------------
