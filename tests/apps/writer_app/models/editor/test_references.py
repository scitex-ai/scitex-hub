#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/writer_app/models/editor/references.py"""

import pytest

# from apps.workspace.writer_app.models.editor.references import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/writer_app/models/editor/references.py
# --------------------------------------------------------------------------------
...
#         "Manuscript", on_delete=models.CASCADE, related_name="figures"
#     )
#
#     # Figure details
...
#
#     manuscript = models.ForeignKey(
#         "Manuscript", on_delete=models.CASCADE, related_name="tables"
#     )
#
#     # Table details
...
#     manuscript = models.ForeignKey(
#         "Manuscript", on_delete=models.CASCADE, related_name="citations"
#     )
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/writer_app/models/editor/references.py
# --------------------------------------------------------------------------------
