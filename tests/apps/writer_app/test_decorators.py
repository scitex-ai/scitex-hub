#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/writer_app/decorators.py"""

import pytest

# from apps.workspace.writer_app.decorators import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/writer_app/decorators.py
# --------------------------------------------------------------------------------
# """
...
# from apps.infra.project_app.models import VisitorAllocation, Project
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/writer_app/decorators.py
# --------------------------------------------------------------------------------
