#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/public_app/models.py"""

import pytest

# from apps.infra.public_app.models import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/public_app/models.py
# --------------------------------------------------------------------------------
...
#
# # EmailVerification model moved to apps.infra.auth_app.models
# # Import here for backwards compatibility
...
#         User, on_delete=models.CASCADE, related_name="cloud_subscriptions"
#     )
...
#     # Relationships
#     user = models.ForeignKey(
#         User, on_delete=models.CASCADE, related_name="cloud_resources"
#     )
...
#     # Relationships
#     user = models.ForeignKey(
#         User, on_delete=models.CASCADE, related_name="cloud_api_keys"
#     )
#
#     # Key details
#     name = models.CharField(max_length=100)
...
#     # Relationships
#     user = models.ForeignKey(
#         User, on_delete=models.CASCADE, related_name="cloud_integrations"
#     )
#
#     # Integration details
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/public_app/models.py
# --------------------------------------------------------------------------------
