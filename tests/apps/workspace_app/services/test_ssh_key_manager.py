#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/workspace_app/services/ssh_key_manager.py"""

import pytest

# from apps.infra.workspace_app.services.ssh_key_manager import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/workspace_app/services/ssh_key_manager.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Timestamp: "2025-11-14 20:42:00 (ywatanabe)"
# # File: /home/ywatanabe/proj/scitex-hub/apps/workspace_app/services/ssh_key_manager.py
# # ----------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/workspace_app/services/ssh_key_manager.py
# --------------------------------------------------------------------------------
