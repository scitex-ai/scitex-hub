#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for apps/permissions_app/templatetags/permission_tags.py"""

import pytest

# from apps.infra.permissions_app.templatetags.permission_tags import ...
...
# --------------------------------------------------------------------------------
# Start of Source Code from: apps/permissions_app/templatetags/permission_tags.py
# --------------------------------------------------------------------------------
# """
...
# --------------------------------------------------------------------------------
# End of Source Code from: apps/permissions_app/templatetags/permission_tags.py
# --------------------------------------------------------------------------------
