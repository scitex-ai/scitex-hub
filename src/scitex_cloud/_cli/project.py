...
def project_list(as_json):
    ...
    from scitex_cloud.project import project_list as _list
...
def project_create(name, description, template):
    ...
    from scitex_cloud.project import project_create as _create
...
def project_rename(slug, new_name):
    """Rename a project."""
    from scitex_cloud.project import project_rename as _rename
