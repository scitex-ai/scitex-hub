...
5. **Verifiable provenance** — Clew links papers, code, data, and execution environments into a hash-verified DAG (Directed Acyclic Graph), reducing the number of decision points reviewers must check and ensuring every result is traceable and reproducible.
