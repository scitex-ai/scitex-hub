...
### Changed
- **README**: Mention scitex.ai as a live instance of this project

## [0.15.1] - 2026-03-15

### Changed
- **README**: Rewrite Problem/Solution as HTML table with 1:1 mapping, h4 titles, top-aligned cells
- **README**: Stack screenshots vertically for larger display
- **README**: Convert Part of SciTeX synergy section to table format
- **README**: Address external review feedback — subtitle, audience line, alpha warning placement
...
### Fixed
- **Scholar two-column layout**: Search, BibTeX, and Graph tabs now properly split into left (main content) and right (controls/sidebar) columns with draggable resizers, matching the Library tab pattern
...
### Added
- **Design rules documentation**: Migrated design partials to docs_app with collapsible sections, anchor deep-linking (#design-rules--sectionId), and syntax highlighting
- **Docs module accent color**: Added blue accent (#4a6a9a) for docs module in app selector and pane border

### Changed
- **Plugin -> App Maker rename**: Renamed plugin references to App Maker across license, docs, and marketplace terms
