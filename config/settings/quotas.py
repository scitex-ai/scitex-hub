...
SLURM_QUOTAS = {
    # Job limits
    "max_concurrent_jobs": get_int("SCITEX_CLOUD_QUOTA_SLURM_MAX_CONCURRENT_JOBS", 4),
    ...
    "interactive_partition": get_str(
        "SCITEX_CLOUD_QUOTA_SLURM_INTERACTIVE_PARTITION", "express"
    ),
...
CELERY_QUOTAS = {
    ...
    "ai_calls_per_minute": get_int("SCITEX_CLOUD_QUOTA_CELERY_AI_CALLS_PER_MINUTE", 10),
    "search_per_minute": get_int("SCITEX_CLOUD_QUOTA_CELERY_SEARCH_PER_MINUTE", 30),
    "compute_per_minute": get_int("SCITEX_CLOUD_QUOTA_CELERY_COMPUTE_PER_MINUTE", 20),
    "pdf_per_hour": get_int("SCITEX_CLOUD_QUOTA_CELERY_PDF_PER_HOUR", 100),
    # Task limits
    "max_task_runtime": get_int("SCITEX_CLOUD_QUOTA_CELERY_MAX_TASK_RUNTIME", 600),
}
...
STORAGE_QUOTAS = {
    "total_gb": get_int("SCITEX_CLOUD_QUOTA_STORAGE_TOTAL_GB", 50),
    "project_max_gb": get_int("SCITEX_CLOUD_QUOTA_STORAGE_PROJECT_MAX_GB", 10),
    "file_upload_mb": get_int("SCITEX_CLOUD_QUOTA_STORAGE_FILE_UPLOAD_MB", 100),
    "temp_gb": get_int("SCITEX_CLOUD_QUOTA_STORAGE_TEMP_GB", 5),
}
...
PROJECT_QUOTAS = {
    "max_projects": get_int("SCITEX_CLOUD_QUOTA_MAX_PROJECTS", 50),
    "max_collaborators_per_project": get_int(
        "SCITEX_CLOUD_QUOTA_MAX_COLLABORATORS_PER_PROJECT", 20
    ),
    "max_api_keys": get_int("SCITEX_CLOUD_QUOTA_MAX_API_KEYS", 10),
}
...
HTTP_QUOTAS = {
    "requests_per_minute": get_int("SCITEX_CLOUD_QUOTA_HTTP_REQUESTS_PER_MINUTE", 120),
    "websocket_connections": get_int("SCITEX_CLOUD_QUOTA_WEBSOCKET_CONNECTIONS", 10),
}
