...
# Logging
# ---------------------------------------
# merge_logging, NOT LOGGING.update: `update` replaces a whole section, so the
# previous form silently deleted every logger the base had wired -- including
# the four app loggers and scitex.errors, and with them the only references to
# the mail_admins handler. See config/settings/_logging_merge.py for the
# measurement. What is written below is a REFINEMENT of the base, not a
# replacement of it: handlers and loggers not named here keep the base's wiring.
