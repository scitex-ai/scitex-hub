...
![Plot Overview](exports/stx_ecdf_overview.png)
...
├── stx_ecdf.csv      # Raw data (immutable)
├── exports/
│   ├── stx_ecdf.png          # Main plot image
│   ├── stx_ecdf.svg          # Vector version
│   ├── stx_ecdf_hitmap.png   # Hit detection image
│   └── stx_ecdf_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/distribution/stx_ecdf.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/distribution/stx_ecdf.pltz.d")
```

---

*Generated: 2025-12-16 12:21:36*
