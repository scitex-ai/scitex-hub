...
![Plot Overview](exports/hist_overview.png)
...
├── hist.csv      # Raw data (immutable)
├── exports/
│   ├── hist.png          # Main plot image
│   ├── hist.svg          # Vector version
│   ├── hist_hitmap.png   # Hit detection image
│   └── hist_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/distribution/hist.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/distribution/hist.pltz.d")
```

---

*Generated: 2025-12-16 12:21:18*
