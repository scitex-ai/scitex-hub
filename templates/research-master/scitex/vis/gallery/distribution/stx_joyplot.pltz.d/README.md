...
![Plot Overview](exports/stx_joyplot_overview.png)
...
├── stx_joyplot.csv      # Raw data (immutable)
├── exports/
│   ├── stx_joyplot.png          # Main plot image
│   ├── stx_joyplot.svg          # Vector version
│   ├── stx_joyplot_hitmap.png   # Hit detection image
│   └── stx_joyplot_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/distribution/stx_joyplot.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/distribution/stx_joyplot.pltz.d")
```

---

*Generated: 2025-12-16 12:21:41*
