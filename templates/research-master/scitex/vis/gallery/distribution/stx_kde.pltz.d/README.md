...
![Plot Overview](exports/stx_kde_overview.png)
...
├── stx_kde.csv      # Raw data (immutable)
├── exports/
│   ├── stx_kde.png          # Main plot image
│   ├── stx_kde.svg          # Vector version
│   ├── stx_kde_hitmap.png   # Hit detection image
│   └── stx_kde_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/distribution/stx_kde.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/distribution/stx_kde.pltz.d")
```

---

*Generated: 2025-12-16 12:21:31*
