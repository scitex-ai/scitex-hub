...
![Plot Overview](exports/hist2d_overview.png)
...
├── hist2d.csv      # Raw data (immutable)
├── exports/
│   ├── hist2d.png          # Main plot image
│   ├── hist2d.svg          # Vector version
│   ├── hist2d_hitmap.png   # Hit detection image
│   └── hist2d_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/distribution/hist2d.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/distribution/hist2d.pltz.d")
```

---

*Generated: 2025-12-16 12:21:25*
