...
![Plot Overview](exports/plot_overview.png)
...
├── exports/
│   ├── plot.png          # Main plot image
│   ├── plot.svg          # Vector version
│   ├── plot_hitmap.png   # Hit detection image
│   └── plot_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/line/plot.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/line/plot.pltz.d")
```

---

*Generated: 2025-12-16 12:20:39*
