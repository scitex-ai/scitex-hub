...
![Plot Overview](exports/stx_line_overview.png)
...
├── stx_line.csv      # Raw data (immutable)
├── exports/
│   ├── stx_line.png          # Main plot image
│   ├── stx_line.svg          # Vector version
│   ├── stx_line_hitmap.png   # Hit detection image
│   └── stx_line_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/line/stx_line.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/line/stx_line.pltz.d")
```

---

*Generated: 2025-12-16 12:20:50*
