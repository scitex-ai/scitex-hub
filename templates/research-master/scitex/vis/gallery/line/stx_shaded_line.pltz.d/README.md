# stx_shaded_line.pltz.d

> SciTeX Layered Plot Bundle - Auto-generated README

## Overview

![Plot Overview](exports/stx_shaded_line_overview.png)
...
├── stx_shaded_line.csv      # Raw data (immutable)
├── exports/
│   ├── stx_shaded_line.png          # Main plot image
│   ├── stx_shaded_line.svg          # Vector version
│   ├── stx_shaded_line_hitmap.png   # Hit detection image
│   └── stx_shaded_line_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/line/stx_shaded_line.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/line/stx_shaded_line.pltz.d")
```

---

*Generated: 2025-12-16 12:20:54*
