...
![Plot Overview](exports/step_overview.png)
...
├── step.csv      # Raw data (immutable)
├── exports/
│   ├── step.png          # Main plot image
│   ├── step.svg          # Vector version
│   ├── step_hitmap.png   # Hit detection image
│   └── step_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/line/step.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/line/step.pltz.d")
```

---

*Generated: 2025-12-16 12:20:43*
