...
![Plot Overview](exports/violinplot_overview.png)
...
├── violinplot.csv      # Raw data (immutable)
├── exports/
│   ├── violinplot.png          # Main plot image
│   ├── violinplot.svg          # Vector version
│   ├── violinplot_hitmap.png   # Hit detection image
│   └── violinplot_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/violinplot.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/violinplot.pltz.d")
```

---

*Generated: 2025-12-16 12:22:11*
