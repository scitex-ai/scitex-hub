...
![Plot Overview](exports/stx_barh_overview.png)
...
├── stx_barh.csv      # Raw data (immutable)
├── exports/
│   ├── stx_barh.png          # Main plot image
│   ├── stx_barh.svg          # Vector version
│   ├── stx_barh_hitmap.png   # Hit detection image
│   └── stx_barh_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/stx_barh.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/stx_barh.pltz.d")
```

---

*Generated: 2025-12-16 12:22:01*
