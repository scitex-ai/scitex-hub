# stx_violinplot.pltz.d

> SciTeX Layered Plot Bundle - Auto-generated README

## Overview

![Plot Overview](exports/stx_violinplot_overview.png)
...
├── stx_violinplot.csv      # Raw data (immutable)
├── exports/
│   ├── stx_violinplot.png          # Main plot image
│   ├── stx_violinplot.svg          # Vector version
│   ├── stx_violinplot_hitmap.png   # Hit detection image
│   └── stx_violinplot_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/stx_violinplot.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/stx_violinplot.pltz.d")
```

---

*Generated: 2025-12-16 12:22:24*
