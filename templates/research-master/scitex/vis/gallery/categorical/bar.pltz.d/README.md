...
![Plot Overview](exports/bar_overview.png)
...
├── bar.csv      # Raw data (immutable)
├── exports/
│   ├── bar.png          # Main plot image
│   ├── bar.svg          # Vector version
│   ├── bar_hitmap.png   # Hit detection image
│   └── bar_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/bar.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/bar.pltz.d")
```

---

*Generated: 2025-12-16 12:21:46*
