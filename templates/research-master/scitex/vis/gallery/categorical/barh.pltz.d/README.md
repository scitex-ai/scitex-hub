...
![Plot Overview](exports/barh_overview.png)
...
├── barh.csv      # Raw data (immutable)
├── exports/
│   ├── barh.png          # Main plot image
│   ├── barh.svg          # Vector version
│   ├── barh_hitmap.png   # Hit detection image
│   └── barh_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/barh.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/barh.pltz.d")
```

---

*Generated: 2025-12-16 12:21:50*
