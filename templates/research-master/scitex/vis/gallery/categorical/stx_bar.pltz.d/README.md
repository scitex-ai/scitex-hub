...
![Plot Overview](exports/stx_bar_overview.png)
...
├── stx_bar.csv      # Raw data (immutable)
├── exports/
│   ├── stx_bar.png          # Main plot image
│   ├── stx_bar.svg          # Vector version
│   ├── stx_bar_hitmap.png   # Hit detection image
│   └── stx_bar_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/stx_bar.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/stx_bar.pltz.d")
```

---

*Generated: 2025-12-16 12:21:56*
