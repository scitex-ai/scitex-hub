...
![Plot Overview](exports/stx_box_overview.png)
...
├── stx_box.csv      # Raw data (immutable)
├── exports/
│   ├── stx_box.png          # Main plot image
│   ├── stx_box.svg          # Vector version
│   ├── stx_box_hitmap.png   # Hit detection image
│   └── stx_box_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/stx_box.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/stx_box.pltz.d")
```

---

*Generated: 2025-12-16 12:22:14*
