...
![Plot Overview](exports/stx_violin_overview.png)
...
├── stx_violin.csv      # Raw data (immutable)
├── exports/
│   ├── stx_violin.png          # Main plot image
│   ├── stx_violin.svg          # Vector version
│   ├── stx_violin_hitmap.png   # Hit detection image
│   └── stx_violin_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/stx_violin.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/stx_violin.pltz.d")
```

---

*Generated: 2025-12-16 12:22:18*
