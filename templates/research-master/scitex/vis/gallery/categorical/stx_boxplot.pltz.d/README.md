...
![Plot Overview](exports/stx_boxplot_overview.png)
...
├── stx_boxplot.csv      # Raw data (immutable)
├── exports/
│   ├── stx_boxplot.png          # Main plot image
│   ├── stx_boxplot.svg          # Vector version
│   ├── stx_boxplot_hitmap.png   # Hit detection image
│   └── stx_boxplot_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/categorical/stx_boxplot.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/categorical/stx_boxplot.pltz.d")
```

---

*Generated: 2025-12-16 12:22:22*
