...
![Plot Overview](exports/pie_overview.png)
...
├── pie.csv      # Raw data (immutable)
├── exports/
│   ├── pie.png          # Main plot image
│   ├── pie.svg          # Vector version
│   ├── pie_hitmap.png   # Hit detection image
│   └── pie_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/special/pie.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/special/pie.pltz.d")
```

---

*Generated: 2025-12-16 12:24:01*
