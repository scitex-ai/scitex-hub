# stx_rectangle.pltz.d

> SciTeX Layered Plot Bundle - Auto-generated README

## Overview

![Plot Overview](exports/stx_rectangle_overview.png)
...
├── stx_rectangle.csv      # Raw data (immutable)
├── exports/
│   ├── stx_rectangle.png          # Main plot image
│   ├── stx_rectangle.svg          # Vector version
│   ├── stx_rectangle_hitmap.png   # Hit detection image
│   └── stx_rectangle_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/special/stx_rectangle.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/special/stx_rectangle.pltz.d")
```

---

*Generated: 2025-12-16 12:24:11*
