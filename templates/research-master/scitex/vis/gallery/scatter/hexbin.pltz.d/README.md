...
![Plot Overview](exports/hexbin_overview.png)
...
├── hexbin.csv      # Raw data (immutable)
├── exports/
│   ├── hexbin.png          # Main plot image
│   ├── hexbin.svg          # Vector version
│   ├── hexbin_hitmap.png   # Hit detection image
│   └── hexbin_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/scatter/hexbin.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/scatter/hexbin.pltz.d")
```

---

*Generated: 2025-12-16 12:22:35*
