...
![Plot Overview](exports/stx_scatter_overview.png)
...
├── stx_scatter.csv      # Raw data (immutable)
├── exports/
│   ├── stx_scatter.png          # Main plot image
│   ├── stx_scatter.svg          # Vector version
│   ├── stx_scatter_hitmap.png   # Hit detection image
│   └── stx_scatter_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/scatter/stx_scatter.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/scatter/stx_scatter.pltz.d")
```

---

*Generated: 2025-12-16 12:22:30*
