...
![Plot Overview](exports/scatter_overview.png)
...
├── scatter.csv      # Raw data (immutable)
├── exports/
│   ├── scatter.png          # Main plot image
│   ├── scatter.svg          # Vector version
│   ├── scatter_hitmap.png   # Hit detection image
│   └── scatter_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/scatter/scatter.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/scatter/scatter.pltz.d")
```

---

*Generated: 2025-12-16 12:22:26*
