...
![Plot Overview](exports/quiver_overview.png)
...
├── quiver.csv      # Raw data (immutable)
├── exports/
│   ├── quiver.png          # Main plot image
│   ├── quiver.svg          # Vector version
│   ├── quiver_hitmap.png   # Hit detection image
│   └── quiver_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/vector/quiver.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/vector/quiver.pltz.d")
```

---

*Generated: 2025-12-16 12:23:47*
