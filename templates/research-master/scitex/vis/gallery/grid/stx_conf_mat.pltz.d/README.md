...
![Plot Overview](exports/stx_conf_mat_overview.png)
...
├── stx_conf_mat.csv      # Raw data (immutable)
├── exports/
│   ├── stx_conf_mat.png          # Main plot image
│   ├── stx_conf_mat.svg          # Vector version
│   ├── stx_conf_mat_hitmap.png   # Hit detection image
│   └── stx_conf_mat_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/grid/stx_conf_mat.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/grid/stx_conf_mat.pltz.d")
```

---

*Generated: 2025-12-16 12:23:23*
