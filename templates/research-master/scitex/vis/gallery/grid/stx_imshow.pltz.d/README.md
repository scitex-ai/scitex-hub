...
![Plot Overview](exports/stx_imshow_overview.png)
...
├── stx_imshow.csv      # Raw data (immutable)
├── exports/
│   ├── stx_imshow.png          # Main plot image
│   ├── stx_imshow.svg          # Vector version
│   ├── stx_imshow_hitmap.png   # Hit detection image
│   └── stx_imshow_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/grid/stx_imshow.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/grid/stx_imshow.pltz.d")
```

---

*Generated: 2025-12-16 12:23:06*
