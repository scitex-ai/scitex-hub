...
![Plot Overview](exports/stx_heatmap_overview.png)
...
├── stx_heatmap.csv      # Raw data (immutable)
├── exports/
│   ├── stx_heatmap.png          # Main plot image
│   ├── stx_heatmap.svg          # Vector version
│   ├── stx_heatmap_hitmap.png   # Hit detection image
│   └── stx_heatmap_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/grid/stx_heatmap.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/grid/stx_heatmap.pltz.d")
```

---

*Generated: 2025-12-16 12:23:21*
