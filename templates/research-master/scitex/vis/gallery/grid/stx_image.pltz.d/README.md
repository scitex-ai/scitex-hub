...
![Plot Overview](exports/stx_image_overview.png)
...
├── stx_image.csv      # Raw data (immutable)
├── exports/
│   ├── stx_image.png          # Main plot image
│   ├── stx_image.svg          # Vector version
│   ├── stx_image_hitmap.png   # Hit detection image
│   └── stx_image_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/grid/stx_image.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/grid/stx_image.pltz.d")
```

---

*Generated: 2025-12-16 12:23:13*
