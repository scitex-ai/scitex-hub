# stx_fill_between.pltz.d

> SciTeX Layered Plot Bundle - Auto-generated README

## Overview

![Plot Overview](exports/stx_fill_between_overview.png)
...
├── stx_fill_between.csv      # Raw data (immutable)
├── exports/
│   ├── stx_fill_between.png          # Main plot image
│   ├── stx_fill_between.svg          # Vector version
│   ├── stx_fill_between_hitmap.png   # Hit detection image
│   └── stx_fill_between_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/area/stx_fill_between.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/area/stx_fill_between.pltz.d")
```

---

*Generated: 2025-12-16 12:22:45*
