...
![Plot Overview](exports/errorbar_overview.png)
...
├── errorbar.csv      # Raw data (immutable)
├── exports/
│   ├── errorbar.png          # Main plot image
│   ├── errorbar.svg          # Vector version
│   ├── errorbar_hitmap.png   # Hit detection image
│   └── errorbar_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/statistical/errorbar.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/statistical/errorbar.pltz.d")
```

---

*Generated: 2025-12-16 12:21:10*
