...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/statistical/stx_errorbar.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/statistical/stx_errorbar.pltz.d")
```

---

*Generated: 2025-12-16 12:21:13*
