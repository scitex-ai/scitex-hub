...
![Plot Overview](exports/stx_mean_ci_overview.png)
...
├── stx_mean_ci.csv      # Raw data (immutable)
├── exports/
│   ├── stx_mean_ci.png          # Main plot image
│   ├── stx_mean_ci.svg          # Vector version
│   ├── stx_mean_ci_hitmap.png   # Hit detection image
│   └── stx_mean_ci_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/statistical/stx_mean_ci.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/statistical/stx_mean_ci.pltz.d")
```

---

*Generated: 2025-12-16 12:21:02*
