...
![Plot Overview](exports/stx_mean_std_overview.png)
...
├── stx_mean_std.csv      # Raw data (immutable)
├── exports/
│   ├── stx_mean_std.png          # Main plot image
│   ├── stx_mean_std.svg          # Vector version
│   ├── stx_mean_std_hitmap.png   # Hit detection image
│   └── stx_mean_std_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/statistical/stx_mean_std.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/statistical/stx_mean_std.pltz.d")
```

---

*Generated: 2025-12-16 12:20:58*
