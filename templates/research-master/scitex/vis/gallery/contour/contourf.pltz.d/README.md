...
![Plot Overview](exports/contourf_overview.png)
...
├── contourf.csv      # Raw data (immutable)
├── exports/
│   ├── contourf.png          # Main plot image
│   ├── contourf.svg          # Vector version
│   ├── contourf_hitmap.png   # Hit detection image
│   └── contourf_overview.png # Visual summary
├── cache/
...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/templates/research-master/scitex/vis/gallery/contour/contourf.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/templates/research-master/scitex/vis/gallery/contour/contourf.pltz.d")
```

---

*Generated: 2025-12-16 12:23:36*
