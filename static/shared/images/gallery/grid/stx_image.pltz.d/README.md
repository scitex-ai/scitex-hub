...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/static/shared/images/gallery/grid/stx_image.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/static/shared/images/gallery/grid/stx_image.pltz.d")
```

---

*Generated: 2025-12-17 10:52:25*
