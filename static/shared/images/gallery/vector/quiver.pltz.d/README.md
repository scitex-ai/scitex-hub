...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/static/shared/images/gallery/vector/quiver.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/static/shared/images/gallery/vector/quiver.pltz.d")
```
