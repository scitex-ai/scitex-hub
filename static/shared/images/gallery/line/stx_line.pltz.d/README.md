...
# Load the bundle
bundle = stx.plt.io.load_layered_pltz_bundle("/app/static/shared/images/gallery/line/stx_line.pltz.d")
...
```python
stx.plt.io.regenerate_cache("/app/static/shared/images/gallery/line/stx_line.pltz.d")
```

---

*Generated: 2025-12-16 12:06:56*
