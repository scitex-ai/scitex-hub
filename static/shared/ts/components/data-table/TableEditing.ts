...
export class TableEditing {
     ...
     */
    handleSelectionNavigation(currentRow, currentCol, mode, reverse, data) {
     ...
     */
    calculateNextPosition(currentRow, currentCol, mode, reverse, data) {
...
//# sourceMappingURL=TableEditing.ts.map
