...
export const PRESERVE_EMPTY_DIRECTORIES: Record<WorkspaceMode, string[]> = {
  ...
  vis: [
    "scitex/vis",
    "scitex/vis/_data", // Input data files
  ...
  writer: [
    "scitex/_writer",
    "scitex/_writer/shared", // Shared resources (symlink target for bibliography)
    "scitex/_writer/01_manuscript",
    "scitex/_writer/01_manuscript/figures", // Symlink target for vis exports
    "scitex/_writer/02_supplementary",
    "scitex/_writer/02_supplementary/figures", // Symlink target for vis exports
    "scitex/_writer/03_revision",
    "scitex/_writer/03_revision/figures", // Symlink target for vis exports
    "shared",
    "figures",
    "tables",
  ],
