...
class ContainerOperations:
    ...
    def finalize_sandbox(self, user: User) -> Dict[str, Any]:
        ...
        try:
            ...
            if final_size > self.config.max_container_size:
                output_sif.unlink()
                return {"success": False, "message": f"Container exceeds size limit"}
    ...
    def build_from_definition(
        self, user: User, definition_content: str
    ) -> Dict[str, Any]:
        """
    ...
    def delete_custom_container(self, user: User) -> Dict[str, Any]:
        ...
        if deleted:
            ...
            return {"success": False, "message": "No custom container or sandbox found"}
