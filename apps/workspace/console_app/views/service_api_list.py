...
class ServiceListAPI(ProjectServiceAPIView):
    ...
    def get(self, request, username, project_slug):
        ...
        try:
            ...
            return JsonResponse({"success": True, "services": service_data})
...
def service_types_api(request):
    ...
    service_types = [
        ...
        {"id": "streamlit", "name": "Streamlit", "description": "Data app framework"},
    ]

    return Response({"success": True, "service_types": service_types})
