#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: /home/ywatanabe/proj/scitex-cloud/apps/scholar_app/services/library_cache.py
"""
...
class LibraryCacheService:
    ...
    def link_paper_to_project(
        ...
        try:
            ...
            library_entry = UserLibrary.objects.filter(user=user, paper=paper).first()
    ...
    @staticmethod
    def unlink_paper_from_project(user: User, paper: SearchIndex, project) -> bool:
        """
