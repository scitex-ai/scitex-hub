...
# FULL-compile view (views/editor/api/compilation.py) can apply the SAME
# precedence without importing scitex at module scope. Re-exported here
# because callers and tests already import these names from this module.
