...
def add_arxiv_files_to_dataset(dataset, arxiv_submission):
    ...
    arxiv_metadata = {
        ...
        "submitted_at": (
            arxiv_submission.submitted_at.isoformat()
            if arxiv_submission.submitted_at
            else None
        ),
        "published_at": (
            arxiv_submission.published_at.isoformat()
...
def add_manuscript_metadata_to_dataset(dataset, manuscript):
    ...
    metadata = {
        ...
        "submission_deadline": (
            manuscript.submission_deadline.isoformat()
        ...
        "updated_at": manuscript.updated_at.isoformat(),
        "last_compiled": (
            manuscript.last_compiled.isoformat() if manuscript.last_compiled else None
        ),
    }
