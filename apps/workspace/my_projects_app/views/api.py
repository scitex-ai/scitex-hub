...
from apps.infra.social_app.models import Activity
...
def api_issues(request):
    ...
    html = render_to_string(
        "my_projects_app/partials/issues_content.html",
        {
...
def api_pulls(request):
    ...
    from apps.infra.project_app.models import PullRequest
    from apps.infra.project_app.services.project_utils import get_current_project
    ...
    html = render_to_string(
        "my_projects_app/partials/pulls_content.html",
        {
            "project": current_project,
            "prs": prs,
            "open_count": open_count,
...
def api_settings(request):
    ...
    html = render_to_string(
        "my_projects_app/partials/settings_content.html",
        {
            "project": current_project,
...
def api_select_project(request):
    ...
    html = render_to_string(
        "my_projects_app/partials/project_workspace.html", context, request=request
    )
    return JsonResponse(
        {
            "success": True,
...
def api_projects_overview(request):
    ...
    html = render_to_string(
        "my_projects_app/partials/projects_overview.html",
...
def api_account_settings(request):
    ...
    html = render_to_string(
        "my_projects_app/partials/account_settings_content.html",
...
def api_explore(request):
    ...
    html = render_to_string(
        "my_projects_app/partials/explore_content.html", context, request=request
    )
    return JsonResponse({"success": True, "html": html})
