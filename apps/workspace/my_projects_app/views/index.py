...
def build_hub_context(request, current_project=None, include_file_browser=False):
    ...
    none of it, and it dominated the page (227 KB on /apps/my-projects/).
    """
...
def render_project_tree_ui(request, current_project, url_owner=None, **tree_kwargs):
    ...
    Projects (/apps/my-projects/), opening a project (/<owner>/<slug>/) and its
...
def _add_file_browser_context(request, project, context):
    ...
    from apps.infra.project_app.models import ProjectStar, ProjectWatch
