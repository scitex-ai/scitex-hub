...
export async function getApplicableTests(context: StatContext): Promise<{
  ...
  const response = await fetch("/apps/figrecipe/api/stats/applicable/", {
    method: "POST",
...
export async function runTest(
  ...
  const response = await fetch("/apps/figrecipe/api/stats/run/", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      test_name: testName,
...
export async function runAllApplicable(
  ...
  const response = await fetch("/apps/figrecipe/api/stats/run-all/", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      groups,
...
export async function buildContextFromPlot(
  ...
  const response = await fetch("/apps/figrecipe/api/stats/context/", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      plot_type: plotType,
