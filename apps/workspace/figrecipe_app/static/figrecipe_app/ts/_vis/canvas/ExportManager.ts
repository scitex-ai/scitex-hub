...
export class ExportManager {
  ...
  public async exportAsFigzBundle(): Promise<void> {
    ...
    try {
      ...
      const response = await fetch("/apps/figrecipe/api/bundles/figz/export/", {
        method: "POST",
        headers: {
  ...
  public async exportFigureImage(
    ...
    try {
      ...
      let exportUrl = `/apps/figrecipe/api/bundles/figz/export-image/?path=${encodeURIComponent(this.currentFigzPath)}&format=${format}&dpi=${dpi}`;
