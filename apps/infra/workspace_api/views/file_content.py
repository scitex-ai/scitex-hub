...
def api_get_file_content(request, file_path):
    ...
    try:
        ...
        # `startswith` admits any sibling directory whose name merely extends
        # the project path, so root ".../proj" would accept
        # "../proj-other/secret.txt" (read another project's files).
