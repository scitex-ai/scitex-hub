...
Usage:
    from apps.infra.platform_app.manifest.loader import load_app_from_manifest
...
def load_app_from_manifest(
    ...
    """
    from apps.infra.platform_app.manifest.parser import ManifestError, ManifestParser
    from apps.infra.platform_app.manifest.validator import validate_manifest
    from apps.infra.platform_app.services.datastore.schema import parse_manifest_schema
    from apps.infra.platform_app.services.external_api.registry import register_api
    from apps.infra.workspace_app.registry import register_module
