...
from apps.infra.llm_app.skills import get_all_skills, get_skill, get_skill_for_page
...
def api_agent_context(request):
    ...
    from apps.infra.llm_app.views.chat import _build_system_prompt
    ...
    mcp_tools = []
    try:
        from apps.infra.llm_app.services.mcp_client import load_openai_tools
