...
class UserLLMService:
    ...
    def _find_active_connection(self):
        ...
        from apps.infra.llm_app.utils import ALL_LLM_SERVICE_IDS
    ...
    def complete(
        ...
        **kwargs,
        ...
        try:
            ...
            # Get API key
            from apps.infra.llm_app.utils import LLM_PROVIDERS
    ...
    def get_usage_stats(self, days: int = 30) -> Dict[str, Any]:
        ...
        from apps.infra.llm_app.services._usage_stats import get_usage_stats as _fn
