...
Prefers local filesystem validation via scitex_hub.appmaker.
...
def validate_app_structure(project) -> list[str]:
    ...
    local_path = _get_local_path(project)
    if local_path:
        from scitex_hub.appmaker import validate_structure
...
def validate_app_security(project) -> list[str]:
    ...
    local_path = _get_local_path(project)
    if local_path:
        from scitex_hub.appmaker import validate_security
