...
def create_pltz_from_plot(request):
    ...
    try:
        ...
        dir_path = result.get("directory_path", result.get("path", ""))
        ...
        return JsonResponse({
            ...
            "preview_url": f"/vis/api/bundles/pltz/preview/?path={dir_path}",
            "hitmap_url": f"/vis/api/bundles/pltz/preview/?path={dir_path}&type=hitmap",
