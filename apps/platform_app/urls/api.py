...
from apps.platform_app.views.api import datastore as datastore_views
from apps.platform_app.views.api import external_api as external_api_views
from apps.platform_app.views.api import filevault as filevault_views
from apps.platform_app.views.api import jobqueue as jobqueue_views
from apps.platform_app.views.api import scitex_bridge as scitex_bridge_views
