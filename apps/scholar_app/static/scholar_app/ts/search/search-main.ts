 ...
 */
function generateBibtexEntry(paper, includeAbstract = false) {
...
function updateToolbarState() {
    ...
    const abstractBtn = document.getElementById("abstractToggleBtn");
    if (abstractBtn)
        abstractBtn.disabled = !hasResults;
}
/**
 ...
 */
export function initSearchMain() {
    initSearchHelp();
    initAbstractToggle();
    initSaveSelected();
    initOpenUrls();
...
//# sourceMappingURL=search-main.ts.map
