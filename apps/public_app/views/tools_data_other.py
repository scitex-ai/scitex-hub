...
# Video tools (alphabetical by name)
VIDEO_TOOLS = [
    {
        ...
        "bookmarklet_url": "/tools/convert-images-to-gif/",
        "icon": "🎬",
    },
    {
        "name": "Edit Video",
        ...
        "bookmarklet_url": "/tools/edit-video/",
        "icon": "🎬",
    },
]

# Rendering tools (alphabetical by name)
RENDERING_TOOLS = [
    {
        "name": "Pick Color",
        ...
        "bookmarklet_url": "/tools/pick-color/",
        "icon": "🎨",
    },
    {
        "name": "View Plot",
        ...
        "bookmarklet_url": "/tools/view-plot/",
        "icon": "📊",
    },
]

# Developer tools (alphabetical by name)
DEVELOPER_TOOLS = [
    {
        "name": "Concat Repo",
        ...
        "bookmarklet_url": "/tools/concat-repo/",
        "icon": "📦",
    },
    {
        "name": "Generate QR",
        ...
        "bookmarklet_url": "/tools/generate-qr/",
        "icon": "📱",
    },
    {
...
RESEARCH_TOOLS = [
    ...
    },
    {
        ...
        "bookmarklet_url": "/tools/scrape-citations/",
        "icon": "📚",
    },
]
